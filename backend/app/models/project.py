...
Persists project state server-side to avoid passing large amounts of data between frontend API calls
"""
...
class ProjectManager:
    """Project manager - responsible for persistent project storage and retrieval"""
