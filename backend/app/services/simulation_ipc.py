...
2. Simulation scripts poll the command directory, execute commands, and write responses to responses/
...
class SimulationIPCClient:
    ...
    def send_command(
        ...
        Raises:
            TimeoutError: Raised when waiting for a response times out
        """
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Target platform (optional)
                ...
                - None: Interview both platforms in dual-platform mode; single platform otherwise
            timeout: Timeout in seconds
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden per-interview item)
                - "twitter": Default to the Twitter platform only
                - "reddit": Default to the Reddit platform only
                - None: Each agent interviews both platforms in dual-platform mode
            timeout: Timeout in seconds
...
class SimulationIPCServer:
    ...
    Polls the command directory, executes commands, and sends responses
    """
