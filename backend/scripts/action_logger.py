...
class ActionLogger:
    """
    Action logger (backward-compatible legacy interface)
...
# Global logger instance (backward-compatible legacy interface)
_global_logger: Optional[ActionLogger] = None


def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Get the global logger instance (backward-compatible legacy interface)"""
