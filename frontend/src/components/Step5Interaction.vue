        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A fast-chat version of the report generation agent, with access to 4 specialized tools and MiroFish's complete memory</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulation environment state, leveraging Global/Local Memory mechanisms for cross-temporal deep attribution analysis</div>
                  </div>
                </div>
                ...
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">An instant query interface based on GraphRAG, optimized for index efficiency, used to rapidly extract specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviewing agent that conducts parallel multi-round dialogues with individuals in the simulated world, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent to dive deeper into the report content' : 'Chat with a simulated individual to understand their perspective' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Type the question you want to ask all selected individuals..."
                rows="3"
              ></textarea>
            </div>
...
const renderMarkdown = (content) => {
  ...
  // Fix numbering for non-consecutive ordered lists: when single-item <ol>s are separated by paragraph content, maintain incrementing numbering
