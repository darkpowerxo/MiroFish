<template>
  <div class="home-container">
    ...
    <nav class="navbar">
      ...
      <div class="nav-links">
        <a href="https://github.com/darkpowerxo/MiroFish" target="_blank" class="github-link">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a single paragraph, <span class="highlight-bold">MiroFish</span> can automatically generate a parallel world of up to <span class="highlight-orange">millions of Agents</span> based on the reality seeds within it. By injecting variables from a god's-eye view, it searches for a <span class="highlight-code">"local optimum"</span> amid complex group interactions in a dynamic environment.
            </p>
            <p class="slogan-text">
              Let the future be rehearsed among Agent swarms, let decisions prevail through countless simulations<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <!-- Bottom Section: Dual-Column Layout -->
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby — upload multiple unstructured documents to initialize the simulation sequence.
          </p>
          ...
          <div class="metrics-row">
            ...
            <div class="metric-card">
              ...
              <div class="metric-label">Up to million-agent simulations</div>
            </div>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity-relation extraction & persona generation & environment config + agent simulation params</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter your simulation or prediction goal in natural language (e.g. If a university publicly revokes a disciplinary action, what public sentiment will emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start simulation - navigate immediately, API calls handled in Process page
