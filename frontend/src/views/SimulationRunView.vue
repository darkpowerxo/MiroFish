...
// Initialize maxRounds directly from query params to ensure child components get the value immediately
...
onMounted(() => {
  ...
  // Log maxRounds config (value already initialized from query params)
  if (maxRounds.value) {
